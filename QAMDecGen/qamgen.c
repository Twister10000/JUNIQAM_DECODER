...
const int16_t Impuls1[NR_OF_SAMPLES] = {0x18F,0x30F,0x471,0x5A7, 0x5A7, 0x471, 0x30F, 0x18F,};
	
const int16_t Impuls2[NR_OF_SAMPLES] = {0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x18F,0x30F,0x471,0x5A7, 0x5A7, 0x471, 0x30F, 0x18F,};
	
const int16_t Impuls3[NR_OF_SAMPLES] = { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
										 0x18F,0x30F,0x471,0x5A7, 0x5A7, 0x471, 0x30F, 0x18F,};
...
void fillBuffer(uint16_t buffer[NR_OF_SAMPLES]) { // HIer werden die Daten für den DAC Befült. In unserem Fall müssten wir schauen wie lange wir warten müssen bis wir den Impuls schicken können.
	...
	//Delay für die Zeitverzögerung vom beschreiben des DAC Buffers
}
